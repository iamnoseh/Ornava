  ...
  return (
    <header className="relative">
      <motion.div
        ...
        className="inline-flex items-center gap-3 rounded-full border border-heritage-gold/[0.24] bg-white/[0.06] px-4 py-2 text-sm text-heritage-paper/[0.76] backdrop-blur-xl"
      ...
      <motion.div animate={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 14 }} transition={{ delay: 0.08, duration: 0.7 }}>
        ...
        <p className="mt-6 max-w-2xl text-base leading-8 text-heritage-paper/[0.68] sm:text-lg">
      ...
      <div className="mt-8 grid max-w-2xl gap-3 text-sm text-heritage-paper/[0.66] sm:grid-cols-3">
