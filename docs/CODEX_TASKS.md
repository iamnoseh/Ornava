...
- Add local CORS settings for future Next.js frontend.
- Add health endpoint.
- Add image upload restoration endpoint.
...
- Add automated tests for validation and restoration modes.
...
- Add manual review workflow for cultural preservation.
